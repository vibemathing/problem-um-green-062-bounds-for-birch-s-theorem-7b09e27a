...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-062-bounds-for-birch-s-theorem-7b09e27a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-062"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-062-bounds-for-birch-s-theorem-7b09e27a-v1",
      "problem_contract_sha256": "5ee2d92775c944a479fc320df45d8422819ed90a8525b166739a10a11572fad0",
      "problem_id": "problem:um-green-062-bounds-for-birch-s-theorem-7b09e27a",
      "route_id": "route:um-green-062-bounds-for-birch-s-theorem-7b09e27a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-062-bounds-for-birch-s-theorem-7b09e27a-source-fidelity-01",
      "graph_id": "graph:um-green-062-bounds-for-birch-s-theorem-7b09e27a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-062-bounds-for-birch-s-theorem-7b09e27a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-062-bounds-for-birch-s-theorem-7b09e27a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $d \\geq 3$ be odd. Give bounds on $\\nu(d)$ such that if $n > \\nu(d)$ then any homogeneous polynomial $F(\\mathbf{x}) \\in \\mathbb{Z}[x_1, \\dots, x_n]$ of degree $d$ has a nontrivial integer zero."
          },
          "statement_sha256": "43a2ae788b631341441e648a47aca85c910356905e2d2385804042929d5e3176"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-062-bounds-for-birch-s-theorem-7b09e27a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-062-bounds-for-birch-s-theorem-7b09e27a-root",
      "route_id": "route:um-green-062-bounds-for-birch-s-theorem-7b09e27a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-062-a0e7b5981456",
        "url": "https://www.unsolvedmath.com/problems/GREEN-062"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
